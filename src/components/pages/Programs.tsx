  ...
  const programs = [
    {
      ...
      description: 'Monthly forum where students and researchers present work, discuss recent papers, and form short-term collaborations focused on AI for Good applications.',
      features: ['Monthy paper discussions', 'Presentation slots for work-in-progress', 'Peer feedback and critique', 'Project-based working groups'],
